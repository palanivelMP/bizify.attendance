package com.bizify.attandance.auth;
...
public class SignatureHelper {
	...
	// TODO externalize value of these keys (ccadiz)
	...
	public static String createSortedUrl(HttpServletRequest request) {
		...
		return createSortedUrl(request.getContextPath() + request.getServletPath() + request.getPathInfo(),
				headersAndParams);
	...
	public static String encodeKeyAsBase64URLSafeString(Key key) {
		return encodeBase64URLSafeString(key.getEncoded());
	}
